function pbrtNode = mPbrtImportMexximpCamera(scene, camera, varargin)
%% Convert a mexximp camera to mPbrt transformation and Camera elements.
%
% pbrtNode = mPbrtImportMexximpCamera(scene, camera) converts the given
...
%   mPbrtImportMexximpCamera( ... 'cameraType', 'orthographic');
%
% Returns an MPbrtElement with identifier Camera and parameters
% filled in based on the mexximp camera.
%
% pbrtNode = mPbrtImportMexximpCamera(scene, camera, varargin)
%
