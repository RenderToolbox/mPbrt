function pbrtNode = mPbrtImportMexximpLight(scene, light, varargin)
%% Convert a mexximp light to mPbrt transformation and LightSource elements.
%
% pbrtNode = mPbrtImportMexximpLight(scene, light) converts the given
...
%
% pbrtNode = mPbrtImportMexximpLight(scene, light, varargin)
%
