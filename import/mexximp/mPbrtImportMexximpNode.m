function pbrtNodes = mPbrtImportMexximpNode(scene, node, varargin)
%% Convert a mexximp node to mPbrt ObjectInstances and transformations.
%
% pbrtNodes = mPbrtImportMexximpNode(scene, node, varargin) converts the given
...
%
% pbrtNodes = mPbrtImportMexximpNode(scene, node, varargin)
%
